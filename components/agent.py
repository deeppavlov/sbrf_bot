...
class HighestConfidenceSelector(Component):
    ...
    def __call__(self, agent, utterances, batch_history, *responses):
...
class Agent(Component):
    ...
    def __call__(self, utterances, ids=None):
        ...
        filtered = self.skills_filter(self, utterances, batch_history)
        responses = []
        ...
        responses = self.skills_selector(self, utterances, batch_history, *responses)
